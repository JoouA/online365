...
if(isset($_GET['selecttype'])){
    $_GET['selecttype']=$_GET['selecttype'];
}else{
    $_GET['selecttype'] = "Name";
}
?>
<table width="558" height="110" border="0" align="center" cellpadding="0" cellspacing="0" >
    <tr>
        <td width="567" height="26" valign="bottom" background="../Image/skintop2.gif"><div align="center">高级查询：</div></td>
    </tr>
    <tr>
        <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="251" >
                                                                ...
                                                                <select name="selecttype"  onchange="window.location='operation.php?action=search&selecttype=' + this.value;">
                                                                  <option value="Name" <?php if(@$_GET['selecttype']=="Name" || @$_GET['selecttype']=="") echo "selected"; ?>>按名称</option>
                                                    ...
                                                    <form name="list1" method="post" action="high_chk.php">
                                                        <tr><input name="selecttype1" type="hidden" value="<?php  if($_GET['selecttype']=="") echo "Name"; else echo $_GET['selecttype']; ?>">
                                                            ...
                                                            <td ><select name="selecttype2" >
                                                                    <option value="audio" selected>影视类</option>
                                                                    <option value="video">音乐类</option>
                                                                </select>
                                                            </td>
                                                        </tr>
                                                        <?php
                                                        $selecttype=@$_GET['selecttype']?$_GET['selecttype']:'Name';
                                                        switch ($selecttype){
                                                            case "Name":
                                                                names();
                                                                break;
                                                        ...
                                                        <tr>
                                                            <td  colspan="2"><div align="center">
                                                                    ...
                                                                    <input name="Submit2" type="button"  value="关闭" onClick="javascript:top.window.close()">
                                                                </div></td>
                                                        </tr>
                                                    </form>
                                                </table>
