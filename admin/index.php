                    ...
                    <form name="a_login" id="a_login" method="post" action="index_ok.php">
                        ...
                        <tr>
                            ...
                            <td width="150" height="30" align="left" valign="middle">
                                <input type="text" name="manager" id="manager" onmouseover="this.style.backgroundColor='#deebef'" onmouseout="this.style.backgroundColor=''"/>
                            </td>
                        </tr>
                        <tr>
                            <td width="75" height="30" align="right" valign="middle"><strong>密 码：</strong></td>
                            <td width="150" height="30" align="left" valign="middle">
                                <input type="password" name="pwd" id="pwd" onmouseover="this.style.backgroundColor='#deebef'" onmouseout="this.style.backgroundColor=''"/>
                            </td>
                        </tr>
                        <tr>
                            <td height="30" colspan="2" align="center" valign="middle">
                                <input type="submit" name="lg" id="lg" value="登录" onclick="return l_chk();" />
                                <!-- <input type="button" name="rt" id="rt" value="" /> -->
                            </td>
                        </tr>
                    </form>
                </table>
