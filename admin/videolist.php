...
<script language="javascript">
    function check(){
        var types=document.list.grade.value;
        if(types=="2"){
            document.list.father.disabled = false;
        }
        else{
            document.list.father.disabled = true;
        }
    }
</script>
                                ...
                                <tr>
                                    <td width="402" valign="top">
                                        <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td width="150" height="40" align="right" valign="middle">目录名称：</td>
                                                <td width="250" height="40" align="left" valign="middle"><input name="names" type="text" id="names"></td>
                                            </tr>
                                            <tr>
                                                <td height="40" align="right" valign="middle">目录级别：</td>
                                                <td height="40" align="left" valign="middle">
                                                    <select name="grade" onchange="check()">
                                            ...
                                            <tr>
                                                <td height="40" align="right" valign="middle">父级名称</td>
                                                <td height="40" align="left" valign="middle">
                                            ...
                                            <tr>
                                                <td height="30" colspan="2" align="center" valign="middle">
                                                    <input name="Submit" type="submit" class="submit" value="添加" onclick="return n_chk();">
                                                    <input name="Submit2" type="button" class="submit" value="返回" onClick="javascript:top.window.close()"></td>
                                            </tr>
                                        </table></td>
                                </tr>
                            </table></td>
