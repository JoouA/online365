                                ...
                                <td width="402" align="center" valign="middle">
                                    ...
                                    if(!$rst->EOF){
                                        ...
                                        <tr>
                                            ...
                                            <td height="20">
                                                <textarea name="textarea" cols="40" rows="5" readonly="readonly"><?php echo $rst->fields[14]; ?></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="30" colspan="2" align="center" valign="middle">
                                                <input name="Submit" type="submit" value="  播  放  "
                                                       onclick="javascript:Wopen=open('operation.php?action=see&id=<?php echo $rst->fields['id']; ?>','','height=600,width=665,scrollbars=no');">
                                                <input name="Submit" type="button" value="  下  载  " onclick="javascript:Wopen=location='download.php?action=audio&id=<?php echo $rst->fields['id']; ?>';">
