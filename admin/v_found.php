                                    ...
                                    <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
                                        ...
                                        <form name="list" method="post" action="#">
                                            <tr>
                                                ...
                                                <td width="250" height="40" align="left" valign="middle">
                                                    <select name="types"  onchange="javascript:list.submit()">
                                                        <option value="name" <?php  if((@$_POST['types']=="name") || (@$_POST['types']=="")) echo "selected"; ?>>按用户名</option>
