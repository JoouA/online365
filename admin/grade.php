    ...
    <tr>
        <td colspan="4" valign="top">
            <table width="380" height="60" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td colspan="4">
                        <table width="375" border="0" align="center" cellpadding="2" cellspacing="0">
                            <tr>
                           ...
                           /* echo "<pre>";
                            ...
                            While(!$a_rst->EOF){
                                ...
                                <tr>
                                    ...
                                    <td height="20" align="center" valign="middle"><?php echo $a_rst->fields['name']; ?></td>
                                    <td height="20" align="center" valign="middle"><?php echo $a_rst->fields['price']; ?></td>
                                </tr>
                                <?php
                                $a_rst->movenext();
                            }
