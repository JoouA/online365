...
<table width="558" height="110" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        <td width="567" height="26" align="center" valign="middle"><font style=" font-size:13px; ">音 频 上 传 列 表</font></td>
    </tr>
    <tr>
        <td>
                                ...
                                <td width="402" valign="top">
                                    <form name="list" method="post" action="dataadd_chk.php" enctype="multipart/form-data">
                                        <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td width="131" height="20" align="right" valign="middle">歌名：</td>
                                                <td width="269" height="20" align="left" valign="middle">
                                                    <input name="names" type="text"  id="names" size="30">*</td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="middle">歌曲图片:</td>
                                                <td height="20" align="left" valign="middle"><input name="picture" type="file"  id="picture" size="15" >*(不大于2M)
                                                </td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="middle">歌曲：</td>
                                            ...
                                            <tr>
                                                ...
                                                <td height="20" align="left" valign="middle">
                                                    ...
                                                    <input type="radio" name="actortype" value="乐队">乐队
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td height="20" align="left" valign="middle">
                                                    <input name="publishtime" type="date"  id="publishtime" size="15">*
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td height="30" colspan="2" align="center">
                                                    ...
                                                    <input name="Submit" type="submit" class="submit"  value="添加" onclick="return trans_video_chk();">
                                                    (*是必填项)
                                                    <input name="Submit2" type="button" class="submit"  value="关闭" onClick="javascript:top.window.close()">                		</td>
                                            </tr>
                                        </table>
                                    </form>
                                </td>
