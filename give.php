...
<table width="558" height="110" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        <td width="567" height="26" valign="bottom"><div align="center"><font style="color:#000000; font-size:13px; ">点歌界面</font></div></td>
    </tr>
    <tr>
        <td>
                                        ...
                                        <form name="list" method="post" action="#">
                                            ...
                                            <tr>
                                                <td height="40" colspan="2"><div align="center">
                                                        ...
                                                        <input name="Submit" type="button"  value="点播" onclick="return register()">
                                                        <input name="Submit2" type="button"  value="取消" onclick="javascript:top.window.close()">
                                                    </div>
                                                </td>
                                            </tr>
                                        </form>
